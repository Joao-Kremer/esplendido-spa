...
export default function Contact() {
  ...
  return (
    <section
      id="contacto"
      className="py-24 bg-gradient-to-br from-[#0A1628] via-[#1E3A5F] to-[#1E56A0] text-white relative overflow-hidden"
    >
      {/* Floating decorative circles */}
      <div className="absolute top-20 left-10 w-64 h-64 rounded-full bg-[#3B82F6]/5 blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-[#06D6A0] hover:bg-[#05c090] text-[#0A1628] font-semibold px-8 py-4 rounded-full text-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#06D6A0]/30"
            >
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-[#3B82F6] to-[#06D6A0] text-white font-semibold py-3.5 rounded-xl hover:shadow-lg hover:shadow-[#3B82F6]/25 transition-all duration-300 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
