...
export default function Services() {
  ...
  return (
    <section id="servicos" className="py-16 sm:py-24 bg-[#F7F9FC]">
          ...
          {services.map((service, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-5 sm:p-8 border border-gray-100 hover:shadow-xl hover:border-[#06D6A0]/30 hover:-translate-y-1 transition-all duration-300 group cursor-pointer"
                onClick={() => setSelectedService(service)}
              >
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#5B9BD5]/10 to-[#06D6A0]/10 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform">
                  <Icon size={28} className="text-[#5B9BD5]" />
                </div>
                ...
                <span className="inline-flex items-center gap-1 text-[#5B9BD5] text-sm font-semibold group-hover:gap-2 transition-all">
        ...
        {selectedService && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-3xl max-w-lg w-full p-5 sm:p-8 relative max-h-[90vh] overflow-y-auto"
            ...
            >
              ...
              {(() => {
                ...
                return (
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#5B9BD5]/10 to-[#06D6A0]/10 flex items-center justify-center mb-6">
                    <Icon size={32} className="text-[#5B9BD5]" />
                  </div>
                );
              })()}
